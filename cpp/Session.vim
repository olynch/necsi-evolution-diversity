...
nmap \rs :VimuxInteruptRunner
nmap \rx :VimuxCloseRunner
nmap \ri :VimuxInspectRunner
nmap \rl :VimuxRunLastCommand
nmap \rp :VimuxPromptCommand
...
silent only
cd ~/git/necsi-evolution-diversity/cpp
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +78 environment.cpp
badd +30 environment.h
badd +32 test_env.cpp
args environment.cpp
edit environment.cpp
...
setlocal tabstop=4
setlocal tags=~/git/necsi-evolution-diversity/.git/cpp.tags,~/git/necsi-evolution-diversity/.git/tags,./tags,./TAGS,tags,TAGS
...
let s:l = 76 - ((34 * winheight(0) + 23) / 47)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 52 - ((45 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
